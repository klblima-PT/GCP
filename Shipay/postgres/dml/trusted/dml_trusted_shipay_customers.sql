...
MERGE INTO `production-347022.trusted_shipay.customers` AS bronze
USING (
  SELECT
    * EXCEPT (rnk)
  FROM (
...
dt_carga_raw,
	 ...
	 FROM
        `production-347022.raw_shipay.customers` 
...
bronze.access_key_reference = raw.access_key_reference ,
bronze.secret_key_reference = raw.secret_key_reference ,
