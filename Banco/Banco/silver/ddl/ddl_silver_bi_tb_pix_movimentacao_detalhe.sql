-- ** tb_pix_movimentacao_detalhe  **
-- DEVELOPED BY HVAR CONSULTING | DataOps team

 CREATE TABLE IF NOT EXISTS  `corporativo-poc-hvar.silver_bi.tb_pix_movimentacao_detalhe`
(
idrow						INT64,
anomes						STRING,
data						DATE,
...
OPTIONS (
  DESCRIPTION = 'Table tb_pix_movimentacao_detalhe clustered by DataHoraRegistro'
); 
